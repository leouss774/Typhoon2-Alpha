"""Schémas Pydantic pour l'analyse de crédit bancaire.

Portés depuis `backend/models/bank_schemas.py` (projet actuel)
vers la nouvelle architecture `backend/app/`.
"""
...
class BankDecision(BaseModel):
    ...
    indice_confiance: int = Field(default=50, ge=0, le=100, description="Niveau de confiance dans les données déclaratives (0-100)")
